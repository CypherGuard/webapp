        ...
        <Menu>
          ...
          <MenuList>
            <MenuItem icon={<EditIcon />} onClick={edit.onOpen}>
              Editer
              <VaultEdit vault={props.vault} isOpen={edit.isOpen} onOpen={edit.onOpen} onClose={edit.onClose} />
            </MenuItem>
            <MenuItem icon={<AddIcon />} onClick={share.onOpen}>
              Partager
              <VaultShare vault={props.vault} isOpen={share.isOpen} onOpen={share.onOpen} onClose={share.onClose} />
            </MenuItem>
            <MenuItem icon={<ExternalLinkIcon />}>Deplacer les mot de passe</MenuItem>
            <MenuDivider />
